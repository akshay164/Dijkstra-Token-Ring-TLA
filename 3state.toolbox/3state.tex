...
\@x{}\moduleLeftDash\@xx{ {\MODULE} 3state}\moduleRightDash\@xx{}%
...
Dijkstra\mbox{'}s stabilizing 3 state token ring with processes
\end{cpar}%
\end{lcom}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} 3StateTokenRing {\p@lbrace}}%
 \@x{\@s{8.2} {\p@variable} c \.{=} [ k \.{\in} 0 \.{\dotdot} N \.{\mapsto}
 {\IF} k \.{=} 0 \.{\THEN} 1 \.{\ELSE} 0 ] {\p@semicolon}}%
\@pvspace{16.0pt}%
...
\@x{\@s{34.18} {\p@lbrace} {\p@either}}%
 \@x{\@s{56.06} {\p@lbrace} {\p@await} ( c [ self ] \.{+} 1 ) \.{\%} 3 \.{=} c
 [ ( self \.{-} 1 ) ] {\p@semicolon}}%
\@x{\@s{77.95} c [ self ] \.{:=} c [ ( self \.{-} 1 ) ] {\p@semicolon}}%
\@x{\@s{69.75} {\p@rbrace}}%
\@x{\@s{43.76} {\p@or}}%
 \@x{\@s{43.76} {\p@lbrace} {\p@await} ( c [ self ] \.{+} 1 ) \.{\%} 3 \.{=} c
 [ ( self \.{+} 1 ) ] {\p@semicolon}}%
\@x{\@s{69.75} c [ self ] \.{:=} c [ ( self \.{+} 1 ) ]}%
\@x{\@s{61.55} {\p@rbrace}}%
\@x{\@s{43.76} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
 ...
 {\TRUE} {\p@rparen}}%
 \@x{\@s{46.79} {\p@lbrace} {\p@await} ( ( c [ self ] \.{+} 1 ) \.{\%} 3 \.{=}
 c [ 1 ] ) {\p@semicolon}}%
\@x{\@s{56.38} c [ self ] \.{:=} ( c [ 1 ] \.{+} 1 ) \.{\%} 3 {\p@semicolon}}%
\@x{\@s{46.79} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
...
\@pvspace{8.0pt}%
 ...
 {\TRUE} {\p@rparen}}%
\@pvspace{8.0pt}%
 \@x{\@s{54.53} {\p@lbrace} {\p@await} c [ ( self \.{-} 1 ) ] \.{=} c [ 0 ]
 \.{\land} c [ self ] \.{\neq} ( c [ ( N \.{-} 1 ) ] \.{+} 1 ) \.{\%} 3
 {\p@semicolon}}%
 \@x{\@s{64.11} c [ self ] \.{:=} ( c [ ( self \.{-} 1 ) ] \.{+} 1 ) \.{\%} 3
 {\p@semicolon}}%
\@x{\@s{54.53} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} c \.{=} [ k \.{\in} 0 \.{\dotdot} N \.{\mapsto}
 {\IF} k \.{=} 0 \.{\THEN} 1 \.{\ELSE} 0 ]}%
\@pvspace{8.0pt}%
 \@x{ j ( self )\@s{1.16} \.{\defeq} \.{\lor} \.{\land} ( c [ self ] \.{+} 1 )
 \.{\%} 3 \.{=} c [ ( self \.{-} 1 ) ]}%
 \@x{\@s{59.88} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ self ] \.{=} c
 [ ( self \.{-} 1 ) ] ]}%
 \@x{\@s{48.77} \.{\lor} \.{\land} ( c [ self ] \.{+} 1 ) \.{\%} 3 \.{=} c [ (
 self \.{+} 1 ) ]}%
 \@x{\@s{59.88} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ self ] \.{=} c
 [ ( self \.{+} 1 ) ] ]}%
\@pvspace{8.0pt}%
 \@x{ i ( self )\@s{1.59} \.{\defeq} \.{\land} ( ( c [ self ] \.{+} 1 ) \.{\%}
 3 \.{=} c [ 1 ] )}%
 \@x{\@s{48.77} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ self ] \.{=} (
 c [ 1 ] \.{+} 1 ) \.{\%} 3 ]}%
\@pvspace{8.0pt}%
 \@x{ k ( self ) \.{\defeq} \.{\land} c [ ( self \.{-} 1 ) ] \.{=} c [ 0 ]
 \.{\land} c [ self ] \.{\neq} ( c [ ( N \.{-} 1 ) ] \.{+} 1 ) \.{\%} 3}%
 \@x{\@s{48.77} \.{\land} c \.{'} \.{=} [ c {\EXCEPT} {\bang} [ self ] \.{=} (
 c [ ( self \.{-} 1 ) ] \.{+} 1 ) \.{\%} 3 ]}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self\@s{0.48} \.{\in} Procs \.{:} j ( self ) )}%
...
\@pvspace{8.0pt}%
 ...
 1 ) \.{\%} 3 \.{=} c [ ( x \.{-} 1 ) ] \.{\lor} ( c [ x ] \.{+} 1 ) \.{\%} 3
 \.{=} c [ ( x \.{+} 1 ) ] \} )}%
 \@x{\@s{50.12} \.{+} {\IF} ( ( c [ 0 ] \.{+} 1 ) \.{\%} 3 \.{=} c [ 1 ] )
 \.{\THEN} 1 \.{\ELSE} 0}%
 \@x{\@s{50.12} \.{+} {\IF} c [ ( N \.{-} 1 ) ] \.{=} c [ 0 ] \.{\land} c [ N
 ] \.{\neq} ( c [ ( N \.{-} 1 ) ] \.{+} 1 ) \.{\%} 3 \.{\THEN} 1 \.{\ELSE} 0}%
...
\@x{ TypeOK \.{\defeq} \A\, x \.{\in} 0 \.{\dotdot} N \.{:} c [ x ] \.{<} 3}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Dijkstra\mbox{'}s stabilizing 3 State token ring algorithm.
 Made by
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
